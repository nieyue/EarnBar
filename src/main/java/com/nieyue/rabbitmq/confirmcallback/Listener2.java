	    ...
	    public void process(Channel channel, DataRabbitmqDTO dataRabbitmqDTO,Message message) throws IOException   {
	           try {
	        	   ...
	        	   */
	        	   ...
	        	   BoundSetOperations<String, String> bsodatips = stringRedisTemplate.boundSetOps("EarnTurnArticleId"+dataRabbitmqDTO.getArticleId()+"Data"+DateUtil.getImgDir()+"Ips");
	        	   ...
	        	   //统计当日当前人的当前文章每日ip
	        	   BoundSetOperations<String, String> bsodataips = stringRedisTemplate.boundSetOps("EarnTurnAcountId"+dataRabbitmqDTO.getAcountId()+"ArtiticlId"+dataRabbitmqDTO.getArticleId()+"Data"+DateUtil.getImgDir()+"Ips");
			        	   if(isAddIp){
	        	   ...
	        	   */
	        	   ...
	        	   if(!article.getStatus().equals("正常")||article.getStatus().equals("完成")){
	        		   articleService.updateArticle(article);//更新文章数据
		        	   channel.basicAck(message.getMessageProperties().getDeliveryTag(), false);
	        		   return;
	        	   }//完成不长阅读和金额
	        	   ...
	        	   profit.setAcountId(selfData.getAcountId());
	        	   profit.setArticleId(selfData.getArticleId());
	        	   profit.setCreateDate(selfData.getCreateDate());
	        	   profit.setType(0);
	        		  ...
	        		  if(masterAcount!=null&&!masterAcount.equals("")&&masterAcount.getScale()>0.0){
	        			...
	        			Finance masterFinance = masterfinancelist.get(0);
	      	        	...
	      	        	masterProfit.setNumber(selfNumber);	
	      	        	 BoundValueOperations<String, String> bvo=stringRedisTemplate.boundValueOps("EarnTurnScaleIncrement");//合伙人增量
