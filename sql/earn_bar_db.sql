# 数据库 
#创建数据库
DROP DATABASE IF EXISTS earn_bar_db;
CREATE DATABASE earn_bar_db;
...
ALTER TABLE data_tb
ADD UNIQUE INDEX DAY_DATA (create_date, article_id, acount_id) USING BTREE ;
ALTER TABLE profit_tb
ADD UNIQUE INDEX ARTICLE_PROFIT (create_date, article_id, acount_id,type) USING BTREE ;